    ...
    <div class="js-sidebar-scroll">
      <div class="content-side">
        <ul class="nav-main">
          ...
          <li class="nav-main-item"><a class="nav-main-link @if(Route::currentRouteName() == 'admin.invoicing') active @endif" href="{{ route('admin.invoicing') }}"><i class="nav-main-link-icon fa-solid fa-coins"></i><span class="nav-main-link-name">Faturamento</span></a></li>
          ...
          <li class="nav-main-item"><a class="nav-main-link @if(Route::currentRouteName() == 'admin.gifts') active @endif" href="{{ route('admin.gifts') }}"><i class="nav-main-link-icon fa-solid fa-heart-circle-plus"></i><span class="nav-main-link-name">Mimos</span></a></li>
