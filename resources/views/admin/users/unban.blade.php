    ...
    <div class="bg-body-light">
        <div class="content content-full">
          <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Desbanir usuário</h1>
            <nav class="flex-shrink-0 my-2 my-sm-0 ms-sm-3" aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item">Dashboard</li>
                <li class="breadcrumb-item active" aria-current="page">Desbanir usuário</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div class="col-md-8 col-xl-8">
            ...
            <div class="block block-rounded h-100 mb-0">
              ...
              <div class="block-content block-content-full bg-body-light">
                <div class="row g-sm">
                  <div class="col-6">
                    <a class="btn btn-success btn-sm w-100" href="{{ route('admin.unban-confirm', ['id' => $user->id]) }}">
                        <i class="fa-solid fa-circle-check"></i> Desbanir este usuário
                    </a>
                  </div>
                  <div class="col-6">
