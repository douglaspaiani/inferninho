...
<head>
    ...
    <title>Dashmix - Bootstrap 5 Admin Template &amp; UI Framework | DEMO</title>
...
<div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow side-trans-enabled page-header-dark dark-mode">
  ...
  <div class="bg-image" style="background-image: url('{{ URL::asset('admin/assets/media/various/bg_side_overlay_header.jpg') }}');">
    <div class="bg-primary-op">
      <div class="content-header">
        <a class="img-link me-1" href="be_pages_generic_profile.html">
          <img class="img-avatar img-avatar48" src="{{ URL::asset('admin/assets/media/avatars/avatar10.jpg') }}" alt="">
        </a>
        <div class="ms-2">
            ...
            <div class="block-content">
              <ul class="nav-items">
                <li>
                  <a class="d-flex py-2" href="be_pages_generic_profile.html">
                    <div class="flex-shrink-0 mx-3 overlay-container">
                      <img class="img-avatar img-avatar48" src="{{ URL::asset('admin/assets/media/avatars/avatar8.jpg') }}" alt="">
            ...
            <div class="block-content">
              <ul class="nav-items">
                <li>
                  <a class="d-flex py-2" href="be_pages_generic_profile.html">
                    <div class="flex-shrink-0 mx-3 overlay-container">
                      <img class="img-avatar img-avatar48" src="{{ URL::asset('admin/assets/media/avatars/avatar16.jpg') }}" alt="">
                ...
                <li>
                  <a class="d-flex py-2" href="be_pages_generic_profile.html">
                    <div class="flex-shrink-0 mx-3 overlay-container">
                      <img class="img-avatar img-avatar48" src="{{ URL::asset('admin/assets/media/avatars/avatar9.jpg') }}" alt="">
                      <span class="overlay-item item item-tiny item-circle border border-2 border-white bg-muted"></span>
                    </div>
                    <div class="flex-grow-1">
    ...
    <div class="content-header bg-white-5">
      <a class="fw-semibold text-white tracking-wide" href="index.html">
        ...
        <span class="smini-hidden">
          Infer<span class="opacity-75">ninho</span>
        </span>
      </a>
      <div>
