    ...
    <div class="bg-body-light">
        <div class="content content-full">
          <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Chamados de suporte</h1>
        ...
        <div class="">
          @if(count($supports) > 0)
            ...
            <div class="mt-5 text-center">
              <a href="{{ route('admin.support-closed') }}" class="btn btn-hero btn-secondary"><i class="fa-regular fa-circle-xmark"></i> Ver chamados encerrados</a>
            </div>
